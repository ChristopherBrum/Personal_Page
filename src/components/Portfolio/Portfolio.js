    ...
    return(
      <div className="hex-container">
        ...
        <div id="hex2" class="hexagon-wrapper">
            ...
            <a href="https://colabras.herokuapp.com/"><img src="/cobrawhite.png" className="colabras-logo" alt="logo for Colabras Game app" /></a>
        ...
        <div id="hex3" class="hexagon-wrapper">
            ...
            <a href="https://taco-to-yousday.herokuapp.com/"><img src="/taco-white.png" className="taco-logo" alt="logo for Taco To Yousday app" /></a>
        ...
        <div id="hex4" class="hexagon-wrapper">
            <div id="color2" class="hexagon"></div>
            <a href="https://two-wheeled-buy-sell.herokuapp.com/"><img src="/moto-man.png" className="moto-logo" alt="logo for Two Wheeled Buy & Sell app" /></a>
            <div className="portfolio-text-div" >
